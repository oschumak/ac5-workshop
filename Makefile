...
l3ls: ## Deploy l3ls lab
	...
	docker run --rm -it --privileged --name l3ls -w /lab -v $(CURRENT_DIR)/l3ls-lab:/lab -v /var/lib/docker -e PASSWORD=labpass124 -p 5000:5000 ghcr.io/oschumak/ac5-workshop/lab:uid-1009-rev0.2
